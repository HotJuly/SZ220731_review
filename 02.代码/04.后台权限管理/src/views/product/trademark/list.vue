  ...
  <div>
    ...
    <el-table :data="trademarkList" border style="width: 100%; margin: 20px 0">
      ...
      <el-table-column label="操作">
        <template slot-scope="{row}">
          <el-button  v-has="`btn.Trademark.update`" type="warning" size="mini" icon="el-icon-edit" @click="showDialog(row)">编辑</el-button>
          <el-button  v-has="`btn.Trademark.remove`" type="danger" size="mini" icon="el-icon-delete" @click="deleteAttr(row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 
